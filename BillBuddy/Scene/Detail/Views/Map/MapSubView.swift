...
struct MapSubView: View {
    ...
    @StateObject var paymentStore: PaymentService
...
#Preview {
    MapSubView(locationManager: LocationManager(), paymentStore: PaymentService(travel: TravelCalculation.sampletravel), selectedDate: .constant(0.0))
}
